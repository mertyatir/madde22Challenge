...
import threeDotsInactive from "../assets/images/threeDotsInactive.svg"
      ...
      <div className="menu-container" ref={menuRef}>
        ...
        >
          <div className="filterIconContainer">
            {open ? (
              <Image src={threeDots} alt="three dots active" />
            ) : (
              <Image src={threeDotsInactive} alt="three dots inactive" />
            )}
          </div>
